...
@WebServlet("/seemedicinestockmin1")
public class Seemedicinestockmin1 extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public Seemedicinestockmin1() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (loggedUser != null) {
			request.getRequestDispatcher("/WEB-INF/lib/seemedicinestockmin1.jsp").forward(request, response);
		} else {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (loggedUser != null) {
    		...
    		request.setAttribute("pres2", pres2);
	...
	request.setAttribute("errorMessage", "Insert correct data");
}
